...
namespace Microsoft.MixedReality.Toolkit.Input
{
        ...
        IMixedRealityInputRecordingService
    {
		...
		/// /!\ This function is not from MRTK /!\
		/// it was added due to the lack of the eponymous function from the documentation
		/// https://microsoft.github.io/MixedRealityToolkit-Unity/version/mrtk_development/api/Microsoft.MixedReality.Toolkit.Input.IMixedRealityInputRecordingService.html#Microsoft_MixedReality_Toolkit_Input_IMixedRealityInputRecordingService_SaveInputAnimationAsync_System_String_
		public Task<string> SaveInputAnimationAsync(string filename, string directory)
        {
	        if (IsEnabled)
	        {
        ...
        private void PruneBuffer(float startTime)
        {
	        recordingBuffer.CutoffBeforeTime(startTime);
        }
	}
